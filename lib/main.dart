...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      ...
      final ByteData data = await rootBundle.load('packages/tesseract_ocr/images/test_spezi_inhaltstoffe.jpg');
      ...
      home: Scaffold(
          ...
          body: Column(
            children: <Widget>[
              ...
              Image.asset('images/test_spezi_inhaltstoffe.jpg', package: 'tesseract_ocr', height: 30.0),
            ],
          )),
    );
  }
