...
class _ScanningCameraState extends State {
  ...
  void initState() {
    ...
    availableCameras().then((availableCameras) {
      ...
      print('Fehler :${err.code}, ${err.message}');
    });
  }
  ...
  Future _initCameraController(CameraDescription cameraDescription) async {
    ...
    controller.addListener(() {
      ...
      if (controller.value.hasError) {
        print('Kamerafehler: ${controller.value.errorDescription}');
      }
    });
  ...
  void _showCameraException(CameraException e) {
    String errorText = 'Fehler:${e.code}\nFehlermeldung : ${e.description}';
    print(errorText);
  }
  ...
  void _onCapturePressed(context) async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ScanningCropImage(
                  imgPath: path,
                )),
      );
    } catch (e) {
